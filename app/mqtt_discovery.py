...
async def discover_all(client: "MQTTClient | StubClient") -> None:
    ...
    configs: list[tuple[str, dict[str, Any]]] = [
        ...
        build_sensor_config(
            "sun-elevation", "sun_elevation", name="Sun Elevation", unit_of_measurement="°"
        ),
        build_sensor_config(
        ...
        build_binary_sensor_config(
            "precip-30m", "precipitation_next_30m", name="Precipitation 30m", device_class="problem"
        ),
        build_binary_sensor_config(
            "precip-1h", "precipitation_next_1h", name="Precipitation 1h", device_class="problem"
        ),
        build_binary_sensor_config(
